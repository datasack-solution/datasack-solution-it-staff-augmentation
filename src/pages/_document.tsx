...
export default function Document() {
  return (
    <Html lang="en">
      <Head>
        <Script id="gtag" async src="https://www.googletagmanager.com/gtag/js?id=G-RD5F5DH96G"></Script>
        <Script id="gtag-config" dangerouslySetInnerHTML={{
        ...
        <Script id="google-analytics-datalayer" dangerouslySetInnerHTML={{
